 ...
 *
 */
class PayItEasy_Payment_Helper_PayItEasyCore {
	...
	const TEST_URL='https://apistg.pay-it-easy.de/web-api/SSLPayment.po';
	const LIVE_URL='https://api.pay-it-easy.de/web-api/SSLPayment.po';
